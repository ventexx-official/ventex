...
export default function FounderDealsPage() {
 ...
 className={`px-5 py-2 rounded-xl text-sm font-bold transition-all ${activeTab === tab ? "bg-[var(--text)] text-[var(--bg)] shadow-md" : "text-[var(--text2)] hover:text-[var(--text)]"}`}
 >
 ...
 className="px-6 py-3 bg-[var(--text)] text-[var(--bg)] rounded-2xl text-sm font-bold hover:bg-black active:scale-95 transition-all disabled:opacity-50 flex items-center gap-2"
 >
 ...
 <div>
 <label className="block text-xs font-black text-[var(--text2)] uppercase tracking-widest mb-2">
 Limit to Product <span className="normal-case text-[var(--text3)]">(optional)</span>
 </label>
 <select
 ...
 <Ticket className="w-10 h-10 text-[var(--text3)] mx-auto mb-3" />
...
function NavItem({ icon: Icon, label, active, href = "#", collapsed }: any) {
 ...
 active ? "bg-[var(--text)] text-[var(--bg)] shadow-lg shadow-black/10" : "text-[var(--text2)] hover:text-[var(--text)] hover:bg-[var(--bg)]"
