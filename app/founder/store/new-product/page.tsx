...
export default function NewProductPage() {
 ...
 className={`rounded-2xl border p-3 text-sm font-black ${listingType === option.id ? "border-[#222222] bg-[var(--text)] text-[var(--bg)]" : "border-[var(--border)] bg-[var(--bg)] text-[var(--text)]"}`}
 >
 {option.label}
 </button>
 ))}
 ...
 type === option.id 
 ? "border-[#222222] bg-[var(--text)] text-[var(--bg)] shadow-lg" 
