...
export default function FounderBoostPage() {
 ...
 className="mt-3 inline-block px-4 py-2 bg-[var(--text)] text-[var(--bg)] text-xs font-bold rounded-xl"
 >
 ...
 <li key={index} className="flex items-center gap-2 text-sm text-[var(--text2)] font-semibold">
 ...
 "bg-[var(--text)] text-[var(--bg)] shadow-2xl shadow-indigo-500/10 border border-indigo-500/30"
 }`}>
