...
function BecomeSellerInner() {
 ...
 <div className="inline-flex items-center gap-2 bg-[var(--text)] text-[var(--bg)] text-xs font-black uppercase tracking-widest px-4 py-2 rounded-full mb-5">
 ...
 active ? "bg-[var(--text)] text-[var(--bg)] shadow-lg shadow-black/20 scale-110" :
 "bg-[var(--card-bg)] border-[0.5px] border-[var(--border)] text-[var(--text3)]"}
 `}>
 {done ? <CheckCircle className="w-5 h-5" /> : <s.icon className="w-4 h-4" />}
 </div>
 <span className={`text-[10px] font-black uppercase tracking-wider whitespace-nowrap
 ${active ? "text-[var(--text)]" : done ? "text-emerald-500" : "text-[var(--text3)]"}`}>
 {s.label}
 </span>
 </div>
 {idx < steps.length - 1 && (
 ...
 className="flex-1 px-4 py-3.5 bg-[var(--bg)] border-[0.5px] border-[var(--border)] rounded-2xl text-sm font-bold text-[var(--text)] placeholder:text-[var(--text3)] focus:outline-none focus:border-[#222222] focus:bg-[var(--card-bg)] transition-all"
 />
 </div>
 </div>
 ...
 className="w-full py-4 bg-[var(--text)] text-[var(--bg)] rounded-2xl font-black text-sm hover:bg-black active:scale-95 transition-all disabled:opacity-40 disabled:pointer-events-none flex items-center justify-center gap-2 shadow-lg shadow-black/10"
 >
 {phoneLoading ? (
 ...
 ${digit ? "border-[#222222] bg-[var(--text)] text-[var(--bg)] scale-105" : "border-[var(--border)] bg-[var(--bg)] text-[var(--text)]"}
 `}
 />
 ))}
 </div>
 ...
 <span className="text-xs font-black text-[var(--text3)] w-6 flex-shrink-0">{item.step}</span>
 ...
 className="block w-full py-4 bg-[var(--text)] text-[var(--bg)] rounded-2xl font-black text-sm hover:bg-black active:scale-95 transition-all text-center shadow-lg shadow-black/10"
 >
