        ...
        <div className="max-w-5xl mx-auto">
          ...
          <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            ...
            <Link
              ...
              className="bg-[var(--text)] text-[var(--text)] px-5 py-3 rounded-2xl font-bold flex items-center gap-2 hover:bg-black active:scale-95 transition-all w-full sm:w-auto justify-center"
            >
            ...
            {filtered.length === 0 ? (
              <div className="bg-[var(--card-bg)] rounded-3xl border-[0.5px] border-[var(--border)] p-16 text-center">
                ...
                {!search && statusFilter === 'all' && (
                  <Link href="/founder/create-pitch" className="inline-flex items-center gap-2 bg-[var(--text)] text-[var(--text)] px-6 py-3 rounded-2xl font-bold text-sm hover:bg-black transition-colors">
              ...
              filtered.map((pitch) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 ml-4 flex-shrink-0">
                    ...
                    <Link href={`/pitch/${pitch.id}`} className="hidden sm:block px-3 py-1.5 bg-[var(--text)] text-[var(--text)] text-xs font-bold rounded-xl hover:bg-black transition-colors">View</Link>
