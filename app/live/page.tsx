    ...
    <main className="min-h-screen bg-[#F2F2F0] px-4 py-16 text-[#222222]">
      <div className="mx-auto max-w-6xl space-y-10">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <form onSubmit={submitFounder} className="rounded-2xl bg-white p-6 space-y-3">
          ...
          <form onSubmit={submitJudge} className="rounded-2xl bg-white p-6 space-y-3">
        ...
        {status ? <p className="rounded-xl bg-white p-4 text-sm font-bold">{status}</p> : null}
