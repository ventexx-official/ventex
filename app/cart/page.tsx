...
export default function CartPage() {
 ...
 <span className="bg-[var(--bg)] text-[var(--text2)] text-[10px] font-black uppercase tracking-widest px-2 py-1 rounded">
 {product.category}
 </span>
 </div>
 <button 
 ...
 className="px-4 py-3 bg-[var(--text)] text-[var(--bg)] rounded-xl text-sm font-bold hover:bg-black dark:hover:bg-[var(--bg3)] transition-colors disabled:opacity-40 flex items-center gap-1.5 flex-shrink-0"
 >
