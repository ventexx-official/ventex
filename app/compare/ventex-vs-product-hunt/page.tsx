...
export const metadata: Metadata = {
  title: 'Ventex vs Product Hunt - Startup Platform Comparison',
  description: 'See how Ventex compares to Product Hunt for startup fundraising, investor discovery, and pitch management.',
};
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h1 className="mt-4 text-4xl md:text-5xl font-extrabold text-[var(--text)] tracking-tight">
            Ventex vs Product Hunt
          </h1>
          <p className="mt-4 text-lg text-[var(--text2)]">
            Why founders and investors are choosing Ventex over traditional product discovery platforms.
          </p>
        </div>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-[var(--bg2)] border-b border-[var(--border)]">
                ...
                <th className="p-6 font-bold text-[var(--text2)]">Product Hunt</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[var(--border)] text-[var(--text)]">
              <tr>
                ...
                <td className="p-6 text-[var(--text2)]">Product Discovery</td>
              </tr>
              <tr>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <div className="bg-[var(--bg2)] p-8 rounded-2xl">
            ...
            <p className="text-[var(--text2)] leading-relaxed">
              Unlike Product Hunt, Ventex gives founders a unified pitch profile complete with video, documents, and integrated data rooms. You control exactly who sees your sensitive traction metrics, allowing you to pitch globally without compromising confidentiality.
            </p>
          </div>
          <div className="bg-[var(--bg2)] p-8 rounded-2xl">
            <h3 className="text-xl font-bold text-[var(--text)] mb-4">For Investors</h3>
            <p className="text-[var(--text2)] leading-relaxed">
              While Product Hunt focuses on product discovery, Ventex focuses on high-signal discovery. Use granular filtering to find startups matching your exact thesis, review AI-generated summaries, and request data room access in one click.
            </p>
          </div>
        </div>
