 ...
 *,
 ...
 isMe 
 ? 'bg-[var(--text)] text-[var(--bg)] rounded-tr-none' 
 ...
 className="px-5 rounded-2xl bg-[var(--text)] text-[var(--bg)] flex items-center justify-center hover:bg-black transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
 >
