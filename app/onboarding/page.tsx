...
export default function Onboarding() {
 ...
 <div className={`h-1 w-12 rounded-full ${step >= 1 ? 'bg-[var(--text)] dark:bg-[var(--card-bg)]' : 'bg-[#e5e5e5] '}`} />
 <div className={`h-1 w-12 rounded-full ${step >= 2 ? 'bg-[var(--text)] dark:bg-[var(--card-bg)]' : 'bg-[#e5e5e5] '}`} />
 <div className={`h-1 w-12 rounded-full ${step >= 3 ? 'bg-[var(--text)] dark:bg-[var(--card-bg)]' : 'bg-[#e5e5e5] '}`} />
 </div>
 ...
 className="bg-[var(--text)] text-[var(--bg)] px-8 py-2.5 rounded-md font-bold hover:opacity-80 transition-colors disabled:opacity-50"
 >
