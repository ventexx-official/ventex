...
export default function PitchesQueue() {
 ...
 default:
 return (
 <span className="flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold bg-[var(--bg2)]0/10 text-[var(--text2)] border border-[0.5px] border-[var(--border)] ">
