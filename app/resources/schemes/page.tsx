...
export default function SchemesHelperPage() {
 ...
 <article key={scheme.name} className="rounded-3xl border border-[var(--border)] bg-[var(--card-bg)] p-6">
...
function Field({ label, value, onChange }: { label: string; value: string; onChange: (value: string) => void }) {
 ...
 <span className="text-xs font-black uppercase tracking-widest text-[var(--text2)]">{label}</span>
 <input
 value={value}
