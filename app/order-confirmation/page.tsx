      ...
      <div className="max-w-3xl mx-auto">
        ...
        {!sessionId || orders.length === 0 ? (
          ...
          <div className="bg-white dark:bg-[#1a1a1a] rounded-[32px] p-12 text-center border-[0.5px] border-[#e5e5e5] dark:border-[#333333] shadow-xl">
            ...
            <h1 className="text-2xl font-black text-[#222222] dark:text-white tracking-tight mb-2 uppercase">Invalid Confirmation</h1>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-[#1a1a1a] rounded-[32px] p-10 border-[0.5px] border-[#e5e5e5] dark:border-[#333333] text-center shadow-xl relative overflow-hidden">
              ...
              <h1 className="text-3xl font-black text-[#222222] dark:text-white tracking-tighter uppercase mb-2">Order Confirmed!</h1>
              <p className="text-sm text-[#888888] font-medium max-w-md mx-auto mb-6">
                Thank you for your purchase. Your order was successfully processed and split payouts were distributed.
              </p>
              
              <div className="inline-flex items-center gap-4 bg-[#F2F2F0] dark:bg-[#222222] px-6 py-3 rounded-2xl border-[0.5px] border-[#e5e5e5] dark:border-[#333333]">
                <div className="text-left border-r border-[#cccccc] dark:border-[#444444] pr-4">
                  <span className="text-[10px] font-black uppercase text-[#888888] tracking-widest block">Session ID</span>
                  <span className="text-xs font-bold text-[#222222] dark:text-white">{sessionId.slice(0, 15)}...</span>
                </div>
                  ...
                  return (
                    <div key={order.id} className="py-6 first:pt-0 last:pb-0 flex flex-col md:flex-row md:items-center justify-between gap-6">
                      ...
                      <div className="flex gap-4 items-center">
                        <div className="w-16 h-16 bg-[#F2F2F0] dark:bg-[#222222] rounded-xl overflow-hidden flex-shrink-0 flex items-center justify-center relative">
                        ...
                        <div>
                          <h3 className="font-bold text-[#222222] dark:text-white hover:underline text-sm leading-snug">
                            {product.name}
                          </h3>
                      ...
                      <div className="flex flex-wrap items-center gap-3">
                        ...
                        {isDigital && order.download_url && (
                          <a 
                            ...
                            className="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white px-4 py-2.5 rounded-xl font-bold text-xs transition-colors shadow-sm"
                          >
                        ...
                        {hasSubmitted ? (
                          ...
                          <button 
                            ...
                            className="inline-flex items-center gap-2 border-[1.5px] border-[#222222] dark:border-white text-[#222222] dark:text-white px-4 py-2.5 rounded-xl font-bold text-xs hover:bg-[#F2F2F0] dark:hover:bg-[#222222] transition-colors"
                          >
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-[#1a1a1a] rounded-[24px] w-full max-w-lg overflow-hidden shadow-2xl relative animate-in fade-in zoom-in-95 duration-200 border-[0.5px] border-[#e5e5e5] dark:border-[#333333]">
            ...
            <div className="p-8">
              ...
              <p className="text-xs text-[#888888] mb-6">Rate and review your experience with <strong>{reviewItem.product?.name}</strong>.</p>
                    ...
                    <Star 
                      className={`w-8 h-8 transition-colors ${
                        star <= (hoverRating !== null ? hoverRating : rating) 
                          ...
                          : 'text-gray-300 dark:text-[#333333]'
                      }`} 
                    />
                  </button>
                ))}
